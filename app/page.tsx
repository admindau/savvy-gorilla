...
export default function HomePage() {
  ...
  return (
    <>
            ...
            <div className="max-w-2xl">
              ...
              <Reveal delayMs={360}>
                <div className="mt-7 flex flex-wrap gap-3 text-xs">
                  ...
                  >
                    <span className="mr-2 inline-block text-accent/80">→</span>
                    Engage Interface
                  </a>
              ...
              <Reveal delayMs={220}>
                <div className="wk-glass rounded-3xl p-6 md:p-7">
                  ...
                  <p className="mt-4 text-[0.75rem] text-white/55">
                    Slow interactions reveal deeper layers.
                  </p>
                </div>
              </Reveal>
            </div>
      ...
      {/* THE HALL MOMENT */}
      <section className="wk-chamber bg-black py-20">
        <div className="wk-grid" aria-hidden="true" />
        <div className="wk-grain" aria-hidden="true" />
      ...
      <section className="bg-black py-16">
        <Container>
          <div className="wk-glass wk-scan rounded-3xl p-10">
            ...
            <Reveal delayMs={90}>
              <h3 className="display mt-3 text-3xl font-semibold md:text-4xl">
